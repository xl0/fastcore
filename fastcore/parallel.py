...
# %% auto 0
__all__ = ['threaded', 'startthread', 'parallelable', 'ProcessPool', 'parallel', 'add_one', 'run_procs', 'parallel_gen']
...
class ProcessPool(pool.Pool):
    ...
    def __init__(self, max_workers=defaults.cpus, context=None, reuse_workers=True, **kwargs):
        ...
        class NoDaemonProcess(context.Process): daemon=property(fget=lambda s: False, fset=lambda s,v: None)
